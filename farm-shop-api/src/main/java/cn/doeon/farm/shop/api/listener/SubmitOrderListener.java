...
import cn.doeon.farm.shop.bean.model.*;
import cn.doeon.farm.shop.dao.*;
...
import cn.doeon.farm.shop.bean.event.SubmitOrderEvent;
import cn.doeon.farm.shop.bean.order.SubmitOrderOrder;
...
public class SubmitOrderListener {
    ...
    public void defaultSubmitOrderListener(SubmitOrderEvent event) {
        ...
        for (ShopCartOrderDto shopCartOrderDto : shopCartOrders) {
            ...
            // 订单信息
            cn.doeon.farm.shop.bean.model.Order order = new cn.doeon.farm.shop.bean.model.Order();
