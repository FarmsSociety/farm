...
package cn.doeon.farm.shop.scienceActivity.security;

import cn.hutool.core.util.StrUtil;
import cn.hutool.extra.servlet.ServletUtil;
import cn.doeon.farm.shop.common.util.Json;
import cn.doeon.farm.shop.common.util.RedisUtil;
import cn.doeon.farm.shop.security.constants.SecurityConstants;
import cn.doeon.farm.shop.security.exception.BadCredentialsExceptionBase;
import cn.doeon.farm.shop.security.exception.ImageCodeNotMatchExceptionBase;
...
public class LoginAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        ActivityAuthenticationToken adminAuthenticationToken  =  Json.parseObject(requestBody, ActivityAuthenticationToken.class);
        ...
        ActivityAuthenticationToken result = new ActivityAuthenticationToken(user, adminAuthenticationToken.getCredentials());
