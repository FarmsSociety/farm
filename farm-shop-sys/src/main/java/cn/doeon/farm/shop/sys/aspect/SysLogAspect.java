...
package cn.doeon.farm.shop.sys.aspect;

import java.util.Date;


import cn.doeon.farm.shop.common.util.IPHelper;
...
public class SysLogAspect {
	...
	public Object around(ProceedingJoinPoint joinPoint, cn.doeon.farm.shop.common.annotation.SysLog sysLog) throws Throwable {
